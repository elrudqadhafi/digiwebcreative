            ...
            <Col lg="8" xs="12">
              <div className="full-data">
                ...
                <div className="text-content">
                  <h3>Lengkapi Data</h3>
                  <p>
                    Lengkapi data diri Kamu untuk keperluan proses pembayaran
                    dan pengerjaan website. Jika kamu membeli domain .co.id maka
                    dibutuhkan tambahan data berupa NPWP Perusahaan, dan
                    AKTA/SIUP Perusahaan.
                  </p>
                </div>
              </div>
            </Col>
