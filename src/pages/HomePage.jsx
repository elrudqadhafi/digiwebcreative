      ...
      <div className="homepage">
            ...
            <Row className="header-box">
              <Col lg="6">
                ...
                <p className="mb-4">
                  ...
                  Yang berpusat di kota Pekanbaru, kami dapat membantu Anda
                  dalam membangun dan mendesain website yang modern, responsif,
                  dan berfokus pada konten. Kami dapat memberikan solusi
                  pembuatan website profesional yang dapat membantu meningkatkan
                  brand awareness dan bisnis Anda.Membantu Anda memenangkan
                  persaingan bisnis modern yang ketat.
                </p>
                <button
            ...
            <Row>
              ...
              <Col lg="4">
                ...
                <p>
                  ...
                  agar keamanan dan performa website selalu baik.
                </p>
              </Col>
            </Row>
          </Container>
            ...
            <Row>
              ...
              <Col lg="4" md="6" className="mb-lg-0 mb-4">
                <div className="card-box">
                  <h3>91%</h3>
                  <p>
                    Konsumen memutuskan untuk melakukan pembelian atau
                    menggunakan layanan jasa setelah melihat websitenya
                  </p>
                </div>
              </Col>
        ...
        <div className="penjelasan-dua">
          <Container>
            ...
            <Row>
              <Col lg="7">
                <h5>
                  ...
                  Yuk!" Tapi, di balik ajakan itu, ada fakta seru yang perlu
                  kita gali. Yuk, kita bahas beberapa hal keren tentang website
                ...
                <li>
                  ...
                  <span className="list-text">
                    ...
                    diam-diam. Dari situ, kita bisa ngetahui siapa aja yang
                    mampir ke sana. Mulai dari usia, lokasi, sampe gaya hidup
                    mereka. Data ini bisa jadi senjata ampuh buat bikin strategi
                    pemasaran yang pas.
                  </span>
                </li>
                <li>
                  ...
                  <span className="list-text">
                    ...
                    pernah nuntut gaji. Meskipun matahari udah tenggelam,
                    website tetap siaga. Artinya, calon pembeli bisa lihat-lihat
                    produk atau layanan kamu kapan aja, gak ada batasan waktu!
                  </span>
                </li>
                <li>
                  <span className="list-icon">
                  ...
                  <span className="list-text">
                    ...
                    detail penting. Kamu bisa berbagi fitur produk, cerita
                    sukses pelanggan, sampai panduan step-by-step. Informasi
                    yang lengkap ini bisa ngebantu calon pelanggan buat ambil
            ...
            <Row>
              <h5>
                Tapi, ada satu hal yang perlu diperhatikan... <br /> Bikin
                website yang keren dan bisa jualan ternyata butuh perhatian
                lebih, nih!
              </h5>
              <hr />
              <Col lg="6" className="m-auto">
                ...
                <li>
                  ...
                  <span className="list-text">
                    ...
                    konsumen tertarik datang ke web kamu. Gak semudah
                    kelihatannya sih!
                  </span>
                </li>
                <li>
              ...
              <Col lg="6" className="m-auto">
                <li>
                  ...
                  <span className="list-text">
                    Nggak cuma bikin aja, kamu juga harus ikutin tren website
                    biar webmu nggak ketinggalan jaman.
                  </span>
                </li>
                <li>
                  <span className="list-icon">
                  ...
                  <span className="list-text">
                    Troubleshooting website juga perlu kamu kuasai, loh. Gak
                    enak kan kalau ada masalah di web, tapi gak tahu gimana
                    nanganinnya.
                  </span>
                </li>
                <li>
              ...
              <h4>
                Tidak cuma itu aja, <br /> kamu juga harus siap menyisihkan
                waktu untuk ngurus bisnismu Soalnya, bikin dan urus website itu
            ...
            <Row>
              <Col lg="7" className="m-auto">
                <p>
                  ...
                  sementara kami mengurus semua kebutuhan digital Anda.Tidak
                  perlu repot mencari ahli IT untuk mengelola situs web Anda,
                  tak perlu panik mengatasi kendala teknis, dan jangan khawatir
                  tentang desain situs yang menarik,kami punya solusi lengkap
                  untuk semuanya! Hemat waktu, tenaga, dan biaya dengan layanan
                  yang ramah ini.
                </p>
              </Col>
            </Row>
          ...
          <Container>
            <Row>
              ...
              <Col lg="6">
                ...
                <p>
                  Tingkatkan Kredibilitas perusahaan Anda dengan Website keren
                  dan menarik
                </p>
                <ul type="circle">
          ...
          <Container>
            ...
            <Row>
              <p className="text-center mt-5">
                Semua itu Gratis ya. Semua udah termasuk ke dalam paket yang
                kami tawarkan.
              </p>
            </Row>
          </Container>
        ...
        <div className="all-fitur">
          <Container>
            <Row>
              ...
              <p>
                Yuk! Jangan ragu untuk berdiskusi dengan kami mengenai
                fitur-fitur website yang kamu mau. <br /> Tim kami dengan senang
                hati membantu anda.
              </p>
            </Row>
