      ...
      <Container>
        <Row>
          <Col>
            ...
            <p className="mt-4">
              Demi meningkatkan pengalaman penggunaan Layanan kami, mungkin kami
              meminta Anda untuk memberikan informasi pengenal pribadi tertentu,
              seperti nama, nomor telepon, dan alamat email. Data yang kami
              himpun akan digunakan untuk mempermudah komunikasi dengan Anda.
            </p>
            ...
            <ul className="mt-4 mb-4">
              ...
              <li>Membantu dan Mendukung analisis penggunaan Layanan kami.</li>
            </ul>
            <p>
              ...
              tidak mengungkap atau memanfaatkan informasi tersebut untuk tujuan
              lain.
            </p>
            <h5 className="mt-5">Kebijakan Privasi yang Diperbarui</h5>
            <p className="mt-4">
              Kami mempunyai hak untuk memperbarui Kebijakan Privasi kami secara
              berkala. Oleh karena itu, kami sangat menyarankan Anda untuk
              secara rutin memeriksa halaman ini untuk setiap perubahan yang
              mungkin terjadi. Setiap kali ada perubahan, kami akan memberitahu
              Anda dengan mengunggah Kebijakan Privasi yang baru di halaman ini.
              Perubahan-perubahan tersebut akan berlaku segera begitu
              dipublikasikan di halaman ini.
            </p>
            <h5 className="mt-5">Kontak Kami</h5>
            <p className="mt-4">
              Kami ingin mendengar dari Anda jika Anda memiliki pertanyaan atau
              saran mengenai Kebijakan Privasi kami, Jangan ragu untuk
